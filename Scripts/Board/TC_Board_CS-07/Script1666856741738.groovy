...
Mobile.tap(findTestObject('cicle.staging/Board/Label/Label-CreateNewLabel'), 3, FailureHandling.OPTIONAL)

'User click "Name your label" field'
Mobile.tap(findTestObject('cicle.staging/Board/Label/NameYourLabel-Field'), 0)

'User Input Empty "Name of Label"'
...
Mobile.tap(findTestObject('cicle.staging/Board/Label/LabelColor-Navy01'), 0)
