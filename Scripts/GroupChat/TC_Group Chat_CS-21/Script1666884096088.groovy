...
Mobile.tap(findTestObject('cicle.staging/Group Chat/DocumentsMenuOnFile'), 0)

'User click Document with XLSX Format'
Mobile.tap(findTestObject('cicle.staging/Group Chat/XLSX Doc - Recent File'), 0)
