...
'User click "Document & Video" button'
Mobile.tap(findTestObject('cicle.staging/Group Chat/DocumentandVideoAttachment-Button'), 0)

'User click "Video" menu in file'
Mobile.tap(findTestObject('cicle.staging/Group Chat/Video Button-RECENT FILES'), 0)

'User click Video with MOV Format'
Mobile.tap(findTestObject('cicle.staging/Group Chat/MOV Files2'), 0)

Mobile.delay(2)

Mobile.verifyElementVisible(findTestObject('cicle.staging/Group Chat/FormatFileNotAllowed'), 0)
