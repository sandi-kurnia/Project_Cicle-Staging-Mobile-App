...
for (int i = 1; i < 2; i++) {
    'User clicks on one of the deleted messages to be copied'
...
Mobile.tap(findTestObject('Object Repository/cicle.staging/Group Chat/CopyTextButton'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/cicle.staging/Group Chat/AssertCopyTextToClipBoard'), 0)
