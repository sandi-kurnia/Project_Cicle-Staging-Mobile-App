...
'User click "Image From Gallery" button'
Mobile.tap(findTestObject('cicle.staging/Group Chat/ImageFromGalleryAttachment-Button'), 0)

'Success to "Add Image from Gallery" on Group Chat'
Mobile.tap(findTestObject('cicle.staging/Group Chat/Image-AddImageFromFiles-RECENT FILES'), 0, FailureHandling.STOP_ON_FAILURE)
