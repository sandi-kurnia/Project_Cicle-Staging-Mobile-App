...
'User click "Image From Camera" button'
Mobile.tap(findTestObject('cicle.staging/Group Chat/ImageFromCameraAttachment-Button'), 0)

'User click "Shutter Camera" button'
Mobile.tap(findTestObject('cicle.staging/Group Chat/shutterCamera-Button'), 0, FailureHandling.STOP_ON_FAILURE)

'User click "Check" button on Camera'
Mobile.tap(findTestObject('Object Repository/cicle.staging/Group Chat/CheckCameraButton'), 0)
