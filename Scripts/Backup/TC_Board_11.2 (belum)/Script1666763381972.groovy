...
Mobile.swipe(824, 324, 424, 324)

Mobile.delay(3)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tapAndHoldAtPosition(925, 331, 2)

Mobile.tap(findTestObject('cicle.staging/Board/InsetLinkNotes(Description)-ToolbarButton'), 0)

Mobile.tap(findTestObject('cicle.staging/Board/TextToDisplayInsertLink-Field'), 0)

Mobile.setText(findTestObject('cicle.staging/Board/TextToDisplayInsertLink-Field'), TextToDisplay, 0)
