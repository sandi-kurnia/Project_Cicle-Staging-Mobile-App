...
Mobile.tap(findTestObject('cicle.staging/Board/Card/CheersButton'), 0)

Mobile.tap(findTestObject('Object Repository/cicle.staging/Board/GiveemCheers-Field'), 0)

Mobile.setText(findTestObject('Object Repository/cicle.staging/Board/GiveemCheers-Field'), 'Hello World!', 0)
