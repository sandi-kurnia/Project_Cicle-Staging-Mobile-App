...
Mobile.tap(findTestObject('cicle.staging/Board/Comment/AddImageByUpload-Comment'), 0)

Mobile.tap(findTestObject('cicle.staging/Board/Comment/SelectImageOnFiles-Files'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('cicle.staging/Board/Comment/SelectButtonOn-Files'), 0)
